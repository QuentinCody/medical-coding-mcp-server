...
export function registerGetSchema(server: McpServer, env?: SchemaEnv): void {
    const handler = createGetSchemaHandler("MEDICAL_CODING_DATA_DO", "coding");
    ...
    server.registerTool(
        "coding_get_schema",
        {
            ...
            description:
                "Get schema information for staged Medical Coding (HCPCS) data. Shows table structures and row counts. " +
